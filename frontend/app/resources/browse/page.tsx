...
import { Resource, ResourceSectionType as ResourceType } from '@zenly/shared';
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            {activeSection === 'videos' &&
              'Educational videos and guided exercises for mental wellness'}
            {activeSection === 'audios' &&
              'Podcasts, meditations, and audio resources for relaxation'}
            {activeSection === 'articles' &&
              'In-depth articles and written guides on mental health topics'}
          </p>
        </div>
