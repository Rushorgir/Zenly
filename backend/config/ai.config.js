...
export default {
  ...
  SAFETY: {
    ...
    REQUIRED_DISCLAIMERS: {
      CRISIS:
        '🆘 This is a crisis situation. Please reach out immediately to: National Crisis Hotline: ${HOTLINE}',
      MEDICAL:
        "⚕️ I'm not a medical professional. Please consult with a healthcare provider for medical advice.",
      THERAPY:
        "💙 I'm here to support you, but I can't replace professional therapy. Consider speaking with a counselor."
    }
  },
